...
setDebugLevel()
{
    ...
    debugLevel[ssZ80]                    = WARNING;      // Z80 CPU
    debugLevel[ssH37InterruptController] = ALL;          // Interrupt Controller
    debugLevel[ssInterruptController]    = ALL;          // Interrupt Controller
    ...
    debugLevel[ssH37]                    = ALL;          // H37 controller
    ...
    debugLevel[ssMMS77316]               = INFO;
    debugLevel[ssWD1797]                 = INFO;
